	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String entity = request.getParameter("bar");
   	   	String query = "SELECT day FROM (SELECT bill_id FROM transactions) sub NATURAL JOIN bills WHERE bar = '"+entity+"'";
   			...
   			int i = 0;
   	   		for(i = 0; i<list.size(); i++){
   				if(((list.get(i)).keySet().toArray()[0]).equals(result.getString("day"))){
   					int newVal = 1 + (list.get(i)).get(result.getString("day"));
